...
//    }
  ...
  @RequestMapping(value = LOGOUT_PATH, method = GET)
  @Operation(description = "Logout the system, and delete credentials into cookies")
  public ResponseEntity logout() {
    authorizationCookieHandler.deleteAuthenticationCookie(request, response);
    authorizationCookieHandler.deleteRealmCookie(request, response);
